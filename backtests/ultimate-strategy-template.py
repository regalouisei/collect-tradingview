...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/editors_picks/ultimate-strategy-template.pine
...
class Ultimate_Strategy_TemplateStrategy(CtaTemplate):
    """
    Ultimate_Strategy_Template
