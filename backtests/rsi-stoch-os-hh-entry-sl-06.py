...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/rsi-stoch-os-hh-entry-sl-06.pine
...
class Rsi_Stoch_Os_Hh_Entry_Sl_06Strategy(CtaTemplate):
    """
    RSI & Stoch OS + HH Entry + SL 0.6%
