...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/volatility/stellas-supertrend-basic.pine
...
class Stellas_Supertrend_BasicStrategy(CtaTemplate):
    """
    Stella
