...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/momentum/buy-signal-ema-rsi-strategy-cocochoco.pine
...
class Buy_Signal_Ema_Rsi_Strategy_CocochocoStrategy(CtaTemplate):
    """
    Buy Signal EMA & RSI Strategy [CocoChoco]
