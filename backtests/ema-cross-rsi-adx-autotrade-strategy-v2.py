...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/ema-cross-rsi-adx-autotrade-strategy-v2.pine
...
class Ema_Cross_Rsi_Adx_Autotrade_Strategy_V2Strategy(CtaTemplate):
    """
    EMA Cross + RSI + ADX - Strategy V2
