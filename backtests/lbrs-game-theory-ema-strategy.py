...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/lbrs-game-theory-ema-strategy.pine
...
class Lbrs_Game_Theory_Ema_StrategyStrategy(CtaTemplate):
    """
