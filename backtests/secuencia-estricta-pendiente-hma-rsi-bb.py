...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/secuencia-estricta-pendiente-hma-rsi-bb.pine
...
class Secuencia_Estricta_Pendiente_Hma_Rsi_BbStrategy(CtaTemplate):
    """
    Secuencia estricta (pendiente) HMA->RSI BB
