...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/wr-pullbackema-trend-ts-indie.pine
...
class Wr_Pullbackema_Trend_Ts_IndieStrategy(CtaTemplate):
    """
