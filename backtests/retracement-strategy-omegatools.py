...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/retracement-strategy-omegatools.pine
...
class Retracement_Strategy_OmegatoolsStrategy(CtaTemplate):
    """
