...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/moving_averages/trend-flow-x-strategy.pine
...
class Trend_Flow_X_StrategyStrategy(CtaTemplate):
    """
    Trend flow X Strategy
