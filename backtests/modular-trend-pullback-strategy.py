...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/modular-trend-pullback-strategy.pine
...
class Modular_Trend_Pullback_StrategyStrategy(CtaTemplate):
    """
