...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/mdz-strategy-v42-multi-factor-trend-strategy.pine
...
class Mdz_Strategy_V42_Multi_Factor_Trend_StrategyStrategy(CtaTemplate):
    """
    MDZ Strategy v4.2
