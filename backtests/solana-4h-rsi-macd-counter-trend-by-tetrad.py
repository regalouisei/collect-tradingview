...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/solana-4h-rsi-macd-counter-trend-by-tetrad.pine
Converted: 2026-02-25 03:10:16 UTC
Indicators used: MA, ATR
"""
...
class Solana_4H_Rsi_Macd_Counter_Trend_By_TetradStrategy(CtaTemplate):
    """
    Tetrad RSI→RSI Cross→MACD (Sequenced) — Counter-Trend (SL-Only Visuals)
