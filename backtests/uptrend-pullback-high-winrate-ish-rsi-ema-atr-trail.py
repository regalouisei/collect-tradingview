...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/uptrend-pullback-high-winrate-ish-rsi-ema-atr-trail.pine
Converted: 2026-02-25 03:10:16 UTC
Indicators used: RSI, MA, ATR
"""
...
class Uptrend_Pullback_High_Winrate_Ish_Rsi_Ema_Atr_TrailStrategy(CtaTemplate):
    """
    Uptrend Pullback (High Winrate-ish) - RSI + EMA + ATR Trail
