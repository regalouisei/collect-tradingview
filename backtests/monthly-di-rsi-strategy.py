...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/monthly-di-rsi-strategy.pine
...
class Monthly_Di_Rsi_StrategyStrategy(CtaTemplate):
    """
    Monthly DI+ & RSI Strategy
