...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/structural-volatility-expansion-strategy.pine
...
class Structural_Volatility_Expansion_StrategyStrategy(CtaTemplate):
    """
