...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/volatility/multi-condition-supertrend-strategy-atr-alma-wvma.pine
...
class Multi_Condition_Supertrend_Strategy_Atr_Alma_WvmaStrategy(CtaTemplate):
    """
    Multi-Supertrend Moving Average
