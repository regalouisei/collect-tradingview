...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/stochastic-hash-strat-hash-capital-research.pine
...
class Stochastic_Hash_Strat_Hash_Capital_ResearchStrategy(CtaTemplate):
    """
    Stochastic Hash Strat [Hash Capital Research]
