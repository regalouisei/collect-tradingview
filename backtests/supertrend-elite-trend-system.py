...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/trend_analysis/supertrend-elite-trend-system.pine
...
class Supertrend_Elite_Trend_SystemStrategy(CtaTemplate):
    """
    Supertrend Elite Trend System
