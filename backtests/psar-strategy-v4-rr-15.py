...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/moving_averages/psar-strategy-v4-rr-15.pine
...
class Psar_Strategy_V4_Rr_15Strategy(CtaTemplate):
    """
    PSAR Strategy v3 RR 1:5
