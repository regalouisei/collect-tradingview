...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/quality-controlled-trend-strategy-v2-expectancy-focused.pine
...
class Quality_Controlled_Trend_Strategy_V2_Expectancy_FocusedStrategy(CtaTemplate):
    """
