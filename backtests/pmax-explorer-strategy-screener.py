...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/editors_picks/pmax-explorer-strategy-screener.pine
...
class Pmax_Explorer_Strategy_ScreenerStrategy(CtaTemplate):
    """
    PMax Explorer
