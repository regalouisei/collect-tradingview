...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/kama-flip-strategy.pine
...
class Kama_Flip_StrategyStrategy(CtaTemplate):
    """
    12/21 Bands – KAMA Flip TP (Single TP 100%) for BTC on 1D
