...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/btc-cycle-rsi-linreg-bands-dca-strategy-v2.pine
...
class Btc_Cycle_Rsi_Linreg_Bands_Dca_Strategy_V2Strategy(CtaTemplate):
    """
