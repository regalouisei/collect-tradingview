...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/game-theory-ema-with-an-alternate-strategy.pine
...
class Game_Theory_Ema_With_An_Alternate_StrategyStrategy(CtaTemplate):
    """
    Game Theory EMA Strategy - Profitable Edition
