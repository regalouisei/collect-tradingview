...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/dragon-indicator-by-matej.pine
...
class Dragon_Indicator_By_MatejStrategy(CtaTemplate):
    """
    Dragon Indicator by Matej)
