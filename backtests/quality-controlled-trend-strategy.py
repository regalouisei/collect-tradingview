...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/quality-controlled-trend-strategy.pine
...
class Quality_Controlled_Trend_StrategyStrategy(CtaTemplate):
    """
    Quality_Controlled_Trend_Strategy
