...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/rsi-55-ema-volume-sl-marked-no-engulfing.pine
...
class Rsi_55_Ema_Volume_Sl_Marked_No_EngulfingStrategy(CtaTemplate):
    """
    RSI + 55 EMA + Volume (SL Marked, No Engulfing)
