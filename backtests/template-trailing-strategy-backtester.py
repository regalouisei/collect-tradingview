...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/editors_picks/template-trailing-strategy-backtester.pine
...
class Template_Trailing_Strategy_BacktesterStrategy(CtaTemplate):
    """
    Template_Trailing_Strategy_Backtester
