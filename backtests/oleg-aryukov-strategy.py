...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/oleg-aryukov-strategy.pine
...
class Oleg_Aryukov_StrategyStrategy(CtaTemplate):
    """
    Oleg_Aryukov_Strategy
