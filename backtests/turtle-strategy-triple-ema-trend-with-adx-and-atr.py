...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/turtle-strategy-triple-ema-trend-with-adx-and-atr.pine
...
class Turtle_Strategy_Triple_Ema_Trend_With_Adx_And_AtrStrategy(CtaTemplate):
    """
    Triple EMA Trend
