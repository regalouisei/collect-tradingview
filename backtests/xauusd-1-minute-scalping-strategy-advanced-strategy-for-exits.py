...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/xauusd-1-minute-scalping-strategy-advanced-strategy-for-exits.pine
...
class Xauusd_1_Minute_Scalping_Strategy_Advanced_Strategy_For_ExitsStrategy(CtaTemplate):
    """
    XAUUSD 1-Minute Scalping Strategy - FIXED Exits
