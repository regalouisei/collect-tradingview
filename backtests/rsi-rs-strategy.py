...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/rsi-rs-strategy.pine
...
class Rsi_Rs_StrategyStrategy(CtaTemplate):
    """
    Simple RSI-RS Strategy
