...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/editors_picks/built-in-kelly-ratio-for-dynamic-position-sizing.pine
...
class Built_In_Kelly_Ratio_For_Dynamic_Position_SizingStrategy(CtaTemplate):
    """
