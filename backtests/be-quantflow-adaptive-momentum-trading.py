...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/be-quantflow-adaptive-momentum-trading.pine
...
class Be_Quantflow_Adaptive_Momentum_TradingStrategy(CtaTemplate):
    """
    BE-QuantFlow: Adaptive Momentum Trading
