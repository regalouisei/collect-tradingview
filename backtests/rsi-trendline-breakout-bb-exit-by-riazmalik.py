...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/rsi-trendline-breakout-bb-exit-by-riazmalik.pine
...
class Rsi_Trendline_Breakout_Bb_Exit_By_RiazmalikStrategy(CtaTemplate):
    """
    RSI Trendline Breakout BB Exit (2% SL / 3R TP)
