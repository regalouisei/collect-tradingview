...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/supertrend-4-22-sell-backtest-reversed.pine
...
class Supertrend_4_22_Sell_Backtest_ReversedStrategy(CtaTemplate):
    """
    Supertrend (4, 22) Sell Backtest (Reversed)
