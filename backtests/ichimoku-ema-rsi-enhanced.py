...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/ichimoku-ema-rsi-enhanced.pine
...
class Ichimoku_Ema_Rsi_EnhancedStrategy(CtaTemplate):
    """
    Ichimoku + EMA + RSI [Enhanced]
