...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/simple-rsi-strategy-rule-based-higher-timeframe-trading.pine
...
class Simple_Rsi_Strategy_Rule_Based_Higher_Timeframe_TradingStrategy(CtaTemplate):
    """
    Simple RSI [EdgeLab]
