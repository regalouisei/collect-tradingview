...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/volatility/double-h-hthull-andersonsu2026.pine
...
class Double_H_Hthull_Andersonsu2026Strategy(CtaTemplate):
    """
    HalfTrend + Hull (Pure Arrow Mode)
