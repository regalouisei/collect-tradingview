...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/trend-vector-pro-v20.pine
...
class Trend_Vector_Pro_V20Strategy(CtaTemplate):
    """
    Trend Vector Pro v2.0
