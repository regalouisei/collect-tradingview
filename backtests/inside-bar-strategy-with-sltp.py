...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/volatility/inside-bar-strategy-with-sltp.pine
...
class Inside_Bar_Strategy_With_SltpStrategy(CtaTemplate):
    """
    Inside Bar Strategy with SL/TP
