...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/rsi-divergence-strategy-v6.pine
...
class Rsi_Divergence_Strategy_V6Strategy(CtaTemplate):
    """
    Rsi_Divergence_Strategy_V6
