...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/supertrend-dual-strategy-rising-adx.pine
...
class Supertrend_Dual_Strategy_Rising_AdxStrategy(CtaTemplate):
    """
    Supertrend Dual Strategy + Rising ADX (Fixed)
