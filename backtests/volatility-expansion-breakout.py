...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/volatility/volatility-expansion-breakout.pine
...
class Volatility_Expansion_BreakoutStrategy(CtaTemplate):
    """
