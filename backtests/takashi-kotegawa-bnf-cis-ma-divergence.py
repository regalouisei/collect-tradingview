...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/takashi-kotegawa-bnf-cis-ma-divergence.pine
...
class Takashi_Kotegawa_Bnf_Cis_Ma_DivergenceStrategy(CtaTemplate):
    """
    Takashi_Kotegawa_Bnf_Cis_Ma_Divergence
