...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/rsi-macd-multi-timeframe-strategy.pine
...
class Rsi_Macd_Multi_Timeframe_StrategyStrategy(CtaTemplate):
    """
