...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/viop-scalping-original.pine
...
class Viop_Scalping_OriginalStrategy(CtaTemplate):
    """
    VIOP Scalping - Original C# (v1.1)
