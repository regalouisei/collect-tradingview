...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/editors_picks/monthly-returns-in-pinescript-strategies.pine
...
class Monthly_Returns_In_Pinescript_StrategiesStrategy(CtaTemplate):
    """
