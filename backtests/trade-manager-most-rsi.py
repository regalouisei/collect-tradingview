...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/trade-manager-most-rsi.pine
...
class Trade_Manager_Most_RsiStrategy(CtaTemplate):
    """
