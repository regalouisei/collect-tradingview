...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/chromes-momentum-strategy.pine
...
class Chromes_Momentum_StrategyStrategy(CtaTemplate):
    """
    Momentum Strategy with Stop Loss
