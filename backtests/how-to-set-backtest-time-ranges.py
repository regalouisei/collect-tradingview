...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/editors_picks/how-to-set-backtest-time-ranges.pine
...
class How_To_Set_Backtest_Time_RangesStrategy(CtaTemplate):
    """
    How_To_Set_Backtest_Time_Ranges
