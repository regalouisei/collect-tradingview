...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/editors_picks/stop-loss-and-take-profit-in-example.pine
...
class Stop_Loss_And_Take_Profit_In_ExampleStrategy(CtaTemplate):
    """
