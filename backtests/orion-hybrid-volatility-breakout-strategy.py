...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/trend_analysis/orion-hybrid-volatility-breakout-strategy.pine
...
class Orion_Hybrid_Volatility_Breakout_StrategyStrategy(CtaTemplate):
    """
    ORION: Hybrid Strategy [Final Fix v33]
