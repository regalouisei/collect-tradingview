...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/editors_picks/markov-chain-3d-fractalyst.pine
...
class Markov_Chain_3D_FractalystStrategy(CtaTemplate):
    """
    MC Bias Strategy Example
