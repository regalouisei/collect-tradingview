...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/moving_averages/crossover-strategy-multi-timeframe-no-repaint.pine
...
class Crossover_Strategy_Multi_Timeframe_No_RepaintStrategy(CtaTemplate):
    """
    Crossover Strategy multi timeframe
