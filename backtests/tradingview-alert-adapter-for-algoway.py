...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/tradingview-alert-adapter-for-algoway.pine
...
class Tradingview_Alert_Adapter_For_AlgowayStrategy(CtaTemplate):
    """
