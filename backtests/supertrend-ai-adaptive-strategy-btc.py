...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/trend_analysis/supertrend-ai-adaptive-strategy-btc.pine
...
class Supertrend_Ai_Adaptive_Strategy_BtcStrategy(CtaTemplate):
    """
    SuperTrend AI Strategy [Adaptive]
