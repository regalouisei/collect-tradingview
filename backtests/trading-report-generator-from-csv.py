...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/editors_picks/trading-report-generator-from-csv.pine
...
class Trading_Report_Generator_From_CsvStrategy(CtaTemplate):
    """
