...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/legendary-linda-bradford-raschke-orb-turtle-soup-hybrid.pine
...
class Legendary_Linda_Bradford_Raschke_Orb_Turtle_Soup_HybridStrategy(CtaTemplate):
    """
    Raschke-Inspired ORB + Turtle Soup Hybrid
