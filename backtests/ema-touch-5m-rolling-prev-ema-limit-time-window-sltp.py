...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/moving_averages/ema-touch-5m-rolling-prev-ema-limit-time-window-sltp.pine
...
class Ema_Touch_5M_Rolling_Prev_Ema_Limit_Time_Window_SltpStrategy(CtaTemplate):
    """
    EMA Touch (5m) | Rolling Prev-EMA Limit | Time Window | SL/TP | Correct Re-entry Modes
