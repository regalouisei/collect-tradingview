...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/dani-mtf-pullback-strategy.pine
...
class Dani_Mtf_Pullback_StrategyStrategy(CtaTemplate):
    """
