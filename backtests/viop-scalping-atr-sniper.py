...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/viop-scalping-atr-sniper.pine
...
class Viop_Scalping_Atr_SniperStrategy(CtaTemplate):
    """
    VİOP Scalping - ATR SNIPER (V4 - Fully Adjustable)
