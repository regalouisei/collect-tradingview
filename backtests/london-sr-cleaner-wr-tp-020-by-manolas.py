...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/moving_averages/london-sr-cleaner-wr-tp-020-by-manolas.pine
...
class London_Sr_Cleaner_Wr_Tp_020_By_ManolasStrategy(CtaTemplate):
    """
    London SR Cleaner WR (TP 0.20)
