...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/moving_averages/sma-rsi-strategy-entryexit-at-next-open.pine
...
class Sma_Rsi_Strategy_Entryexit_At_Next_OpenStrategy(CtaTemplate):
    """
    SMA + RSI Strategy [Entry/Exit at Next Open]
