...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/moving_averages/1-min-gold-taylor-technique.pine
...
class 1_Min_Gold_Taylor_TechniqueStrategy(CtaTemplate):
    """
    1-Min Gold Taylor Technique
