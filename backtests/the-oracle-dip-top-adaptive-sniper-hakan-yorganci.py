...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/the-oracle-dip-top-adaptive-sniper-hakan-yorganci.pine
...
class The_Oracle_Dip_Top_Adaptive_Sniper_Hakan_YorganciStrategy(CtaTemplate):
    """
    The Oracle: Dip & Top Adaptive Sniper [Hakan Yorganci]
