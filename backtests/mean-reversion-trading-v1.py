...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/mean-reversion-trading-v1.pine
...
class Mean_Reversion_Trading_V1Strategy(CtaTemplate):
    """
