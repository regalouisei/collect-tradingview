...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/range-oscillator-strategy-stoch-confirm.pine
...
class Range_Oscillator_Strategy_Stoch_ConfirmStrategy(CtaTemplate):
    """
