...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/lbrs-game-theory-ema-strategy-alternate.pine
...
class Lbrs_Game_Theory_Ema_Strategy_AlternateStrategy(CtaTemplate):
    """
    Game Theory EMA Strategy
