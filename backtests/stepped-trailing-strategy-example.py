...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/editors_picks/stepped-trailing-strategy-example.pine
...
class Stepped_Trailing_Strategy_ExampleStrategy(CtaTemplate):
    """
