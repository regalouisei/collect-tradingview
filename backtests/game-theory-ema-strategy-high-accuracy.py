...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/game-theory-ema-strategy-high-accuracy.pine
...
class Game_Theory_Ema_Strategy_High_AccuracyStrategy(CtaTemplate):
    """
    Game Theory EMA Strategy - High Accuracy
