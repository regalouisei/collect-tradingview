...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/volatility/bigbull-x-2-strategy.pine
...
class Bigbull_X_2_StrategyStrategy(CtaTemplate):
    """
    bigbull X 2 Strategy
