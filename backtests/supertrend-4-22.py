...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/supertrend-4-22.pine
...
class Supertrend_4_22Strategy(CtaTemplate):
    """
    Supertrend (4, 22) Strategy
