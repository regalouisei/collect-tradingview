...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/moneymakers-scalping-signals.pine
...
class Moneymakers_Scalping_SignalsStrategy(CtaTemplate):
    """
    1m BB + RSI Mean Reversion + DCA (Memcoin) v1b
