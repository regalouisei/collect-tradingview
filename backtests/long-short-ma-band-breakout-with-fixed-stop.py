...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/moving_averages/long-short-ma-band-breakout-with-fixed-stop.pine
...
class Long_Short_Ma_Band_Breakout_With_Fixed_StopStrategy(CtaTemplate):
    """
    Long Short MA %Band Breakout with Fixed Stop + Mode
