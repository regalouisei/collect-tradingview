...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/trama-supertrend-superosc-long-strategy.pine
...
class Trama_Supertrend_Superosc_Long_StrategyStrategy(CtaTemplate):
    """
    TRAMA + Supertrend + SuperOsc Long Strategy
