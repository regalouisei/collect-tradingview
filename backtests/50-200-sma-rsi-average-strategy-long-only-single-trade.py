...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/50-200-sma-rsi-average-strategy-long-only-single-trade.pine
...
class 50_200_Sma_Rsi_Average_Strategy_Long_Only_Single_TradeStrategy(CtaTemplate):
    """
    50 & 200 SMA + RSI Ortalaması Stratejisi (Long Only, Tek İşlem)
