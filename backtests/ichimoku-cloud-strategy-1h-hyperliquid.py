...
Source: /root/.openclaw/workspace/openclaw-tradingview/pinescript/oscillators/ichimoku-cloud-strategy-1h-hyperliquid.pine
...
class Ichimoku_Cloud_Strategy_1H_HyperliquidStrategy(CtaTemplate):
    """
    Ichimoku Cloud Strategy - 1H
